    ...
    def readChunk(self, i1=-1, i2=-1, i3=-1, N1=1, N2=1, N3=1):
        ...
        if (i2 < 0):
            ...
            if N1 != self._header.dims[0]:
                print(("Unable to support N1 {} != {}".format(
                    N1, self._header.dims[0])))
                return None
            ...
            if N2 != self._header.dims[1]:
                print(("Unable to support N2 {} != {}".format(
                    N2, self._header.dims[1])))
                return None
    ...
    def _read_chunk_1d(self, i, N):
        ...
        try:
            f.seek(
                ...
                self._header.num_bytes_per_entry *
                i)
...
class DiskWriteMda:
    ...
    def writeChunk(self, X, i1=-1, i2=-1, i3=-1):
        ...
        if (i2 < 0):
            ...
            if N1 != self._header.dims[0]:
                print(("Unable to support DiskWriteMda N1 {} != {}".format(
                    N1, self._header.dims[0])))
                return None
            ...
            if N1 != self._header.dims[0]:
                ...
                return None
            if N2 != self._header.dims[1]:
                print(("Unable to support DiskWriteMda N2 {} != {}".format(
                    N2, self._header.dims[1])))
                return None
            return self._write_chunk_1d(
                X.ravel(order='F'), i1 + N1 * i2 + N1 * N2 * i3)
